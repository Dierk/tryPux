...
var _user$project$Main$sliceLine = F2(
	function (state, slice) {
		var sliceAngle = function (x) {
			return ((_elm_lang$core$Basics$toFloat(x) * 2.0) * _elm_lang$core$Basics$pi) / _elm_lang$core$Basics$toFloat(state.slices);
		};
		var target = sliceAngle(slice * state.table);
		var origin = sliceAngle(slice);
		var ypos = function (angle) {
			return _elm_lang$core$Basics$toString(
				50.0 + (50.0 * _elm_lang$core$Basics$sin(angle)));
		};
		var xpos = function (angle) {
			return _elm_lang$core$Basics$toString(
				50.0 + (50.0 * _elm_lang$core$Basics$cos(angle)));
		};
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					ypos(target)),
					_elm_lang$svg$Svg_Attributes$stroke('#A0A0F080'),
					_elm_lang$svg$Svg_Attributes$strokeWidth('0.8')
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
var _user$project$Main$allLines = function (state) {
	return A2(
		_elm_lang$core$List$map,
		function (slice) {
			return A2(_user$project$Main$sliceLine, state, slice);
		},
		_elm_lang$core$Native_List.range(1, state.slices));
};
...
var _user$project$Main$state = {slices: 10, table: 2};
var _user$project$Main$State = F2(
	function (a, b) {
		return {slices: a, table: b};
	});
var _user$project$Main$TableMinus = {ctor: 'TableMinus'};
var _user$project$Main$TablePlus = {ctor: 'TablePlus'};
var _user$project$Main$SliceMinus = {ctor: 'SliceMinus'};
var _user$project$Main$SlicePlus = {ctor: 'SlicePlus'};
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$Main$SlicePlus)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Slice +')
							])),
						_elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(state.slices)),
						A2(
						_elm_lang$html$Html$button,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$Main$SliceMinus)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Slice -')
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$Main$TablePlus)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(state.table)),
						A2(
						_elm_lang$html$Html$button,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$Main$TableMinus)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Table -')
							...
							A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$svg$Svg_Attributes$r('49'),
										_elm_lang$svg$Svg_Attributes$fill('transparent'),
										_elm_lang$svg$Svg_Attributes$stroke('papayawhip')
									]),
								_elm_lang$core$Native_List.fromArray(
									[])),
							_user$project$Main$allLines(state)))
					]))
			]));
};
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _user$project$Main$state, view: _user$project$Main$view, update: _user$project$Main$update})
};
